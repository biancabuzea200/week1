...
snarkjs zkey export verificationkey _plonkMultiplier3/circuit_0000.zkey _plonkMultiplier3/verification_key.json

# generate solidity contract
snarkjs zkey export solidityverifier _plonkMultiplier3/circuit_0000.zkey ../_plonkMultiplier3.sol
